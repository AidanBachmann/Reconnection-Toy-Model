...
if burnIn == True: # Computing initial conditions, time and current arrays with burn-in
    Nb = int(1e3) # Number of burn-in steps
    r0,v0,t0,tArr,currentArr = funcs.burnIn(r0,v0,t0,dt,Bz,N,Nb,a,J,currentProfile,args) # Get new initial conditions, time and current arrays
